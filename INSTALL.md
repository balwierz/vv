...
Replace `1.18.4` below with the
[latest release](https://github.com/balwierz/vv/releases/latest) if newer.

### Debian / Ubuntu

```sh
curl -LO https://github.com/balwierz/vv/releases/download/v1.18.4/vv_1.18.4-1_amd64.deb
sudo apt install ./vv_1.18.4-1_amd64.deb        # use arm64 on ARM
```
...
```sh
curl -LO https://github.com/balwierz/vv/releases/download/v1.18.4/vv-gui_1.18.4-1+ubuntu24.04_amd64.deb
sudo apt install ./vv-gui_1.18.4-1+ubuntu24.04_amd64.deb   # use arm64 on ARM
```

On Debian:

```sh
curl -LO https://github.com/balwierz/vv/releases/download/v1.18.4/vv-gui_1.18.4-1+debian13_amd64.deb
sudo apt install ./vv-gui_1.18.4-1+debian13_amd64.deb      # use arm64 on ARM
```
...
```sh
curl -LO https://github.com/balwierz/vv/releases/download/v1.18.4/vv-gui_1.18.4-1+debianforky_amd64.deb
sudo apt install ./vv-gui_1.18.4-1+debianforky_amd64.deb   # use arm64 on ARM
```
...
```sh
base=https://github.com/balwierz/vv/releases/download/v1.18.4
arch=x86_64    # aarch64 on ARM (AWS Graviton, Raspberry Pi 5, …)

curl -LO $base/vv-1.18.4-linux-$arch.tar.gz
curl -LO $base/SHA256SUMS
sha256sum --check --ignore-missing SHA256SUMS

tar -xzf vv-1.18.4-linux-$arch.tar.gz
sudo install vv-1.18.4-linux-$arch/vv /usr/local/bin/
```
