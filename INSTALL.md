...
sudo apt install ./vv_1.23.0-1_amd64.deb        # use arm64 on ARM
```
...
sudo apt install ./vv-gui_1.23.0-1+ubuntu24.04_amd64.deb   # use arm64 on ARM
```

On Debian:

```sh
curl -LO https://github.com/balwierz/vv/releases/download/v1.23.0/vv-gui_1.23.0-1+debian13_amd64.deb
sudo apt install ./vv-gui_1.23.0-1+debian13_amd64.deb      # use arm64 on ARM
```
...
```sh
curl -LO https://github.com/balwierz/vv/releases/download/v1.23.0/vv-gui_1.23.0-1+debianforky_amd64.deb
sudo apt install ./vv-gui_1.23.0-1+debianforky_amd64.deb   # use arm64 on ARM
```
...
curl -LO $base/vv-1.23.0-linux-$arch.tar.gz
curl -LO $base/SHA256SUMS
sha256sum --check --ignore-missing SHA256SUMS

tar -xzf vv-1.23.0-linux-$arch.tar.gz
sudo install vv-1.23.0-linux-$arch/vv /usr/local/bin/
```
